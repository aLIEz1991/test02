...
- (void)viewDidLoad {
    ...
    //定义Nav颜色
    [[[self navigationController] navigationBar] setBackgroundImage:[UIImage getImageWithColor:[UIColor whiteColor] size:CGSizeMake(self.view.frame.size.height, 64)] forBarMetrics:UIBarMetricsDefault];
